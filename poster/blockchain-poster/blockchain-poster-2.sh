...
tx_id=$(ethereal --connection=https://rpc.ankr.com/polygon transaction send --from=$USER_ADDRESS --to=$destination_address --amount="0" --data "$plain_contents" --gaslimit 0 --wait)
