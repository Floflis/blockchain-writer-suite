...
tx_id=$(ethereal --connection="https://polygon-mainnet.public.blastapi.io" transaction send --from=$USER_ADDRESS --to=$destination_address --amount="0" --data "$plain_contents" --gaslimit 0 --wait)
