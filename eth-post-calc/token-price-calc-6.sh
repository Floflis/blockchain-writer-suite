...
# **Corrected Cost Ether Assignment:**
cost_ether=$(bc -l <<< "scale=18; $cost_wei / 1000000000000000000")  # Direct calculation within bc
...
# Add error handling mechanisms to gracefully handle potential issues like:
# - API unavailability
# - Invalid data from the APIs

# Example:
if [[ $? -ne 0 ]]; then
  echo "Error: An error occurred while retrieving data."
  exit 1
fi
